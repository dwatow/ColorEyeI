<<<<<<< HEAD
========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : xMsrPoint
========================================================================


AppWizard has created this xMsrPoint application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your xMsrPoint application.
...
xMsrPoint.h
    ...
    CXMsrPointApp application class.
...
res\xMsrPoint.ico
    ...
    icon is included by the main resource file xMsrPoint.rc.
...
xMsrPointDlg.h, xMsrPointDlg.cpp - the dialog
    These files contain your CXMsrPointDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in xMsrPoint.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CXMsrPointDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named xMsrPoint.pch and a precompiled types file named StdAfx.obj.
