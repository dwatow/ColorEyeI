========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : MsrItems
========================================================================


AppWizard has created this MsrItems application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MsrItems application.
...
MsrItems.h
    ...
    CMsrItemsApp application class.
...
res\MsrItems.ico
    ...
    icon is included by the main resource file MsrItems.rc.
...
MsrItemsDlg.h, MsrItemsDlg.cpp - the dialog
    These files contain your CMsrItemsDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in MsrItems.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMsrItemsDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named MsrItems.pch and a precompiled types file named StdAfx.obj.
