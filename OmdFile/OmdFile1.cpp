...
//檔案資料      
    ...
    //5nits
	D_Omd.At(Nits, Pn9, 0).SetLv( 123);
    D_Omd.At(Nits, Pn9, 1).SetLv( 223);
    D_Omd.At(Nits, Pn9, 2).SetLv( 323);
    D_Omd.At(Nits, Pn9, 3).SetLv( 423);
    D_Omd.At(Nits, Pn9, 4).SetLv( 523);
    D_Omd.At(Nits, Pn9, 5).SetLv( 623);
    D_Omd.At(Nits, Pn9, 6).SetLv( 723);
    D_Omd.At(Nits, Pn9, 7).SetLv( 823);
    D_Omd.At(Nits, Pn9, 8).SetLv( 923);
