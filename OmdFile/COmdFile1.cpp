...
void COmdFile1::OmdToTxt()
{
    ...
    m_dTxt.push_back("White\t" + m_dOmd.At(White, Pn1, 0).GetStrLv() + "\t" + m_dOmd.At(White, Pn1, 0).GetStrSx() + "\t" + m_dOmd.At(White, Pn1, 0).GetStrSy() + "\t" + m_dOmd.At(White, Pn1, 0).GetStrDu() + "\t" + m_dOmd.At(White, Pn1, 0).GetStrDv() + "\t灰階:XX\t" + m_dOmd.At(Nits, Pn9, 0).GetStrLv() + "\t" + m_dOmd.At(Nits, Pn9, 1).GetStrLv() + "\t" + m_dOmd.At(Nits, Pn9, 2).GetStrLv() + "\t\t\t\t" + m_dOmd.At(Nits, Pn9, 0).GetStrSx() + "\t" + m_dOmd.At(Nits, Pn9, 1).GetStrSx() + "\t" + m_dOmd.At(Nits, Pn9, 2).GetStrSx() + "\t\t\t\t" + m_dOmd.At(Nits, Pn9, 0).GetStrSy() + "\t" + m_dOmd.At(Nits, Pn9, 1).GetStrSy() + "\t" + m_dOmd.At(Nits, Pn9, 2).GetStrSy() + "\t\t\t\t" + m_dOmd.At(Nits, Pn9, 0).GetStrT() + "\t" + m_dOmd.At(Nits, Pn9, 1).GetStrT() + "\t" + m_dOmd.At(Nits, Pn9, 2).GetStrT() + "\t\t\t\t" + m_dOmd.At(Nits, Pn9, 0).GetStrDuv() + "\t" + m_dOmd.At(Nits, Pn9, 1).GetStrDuv() + "\t" + m_dOmd.At(Nits, Pn9, 2).GetStrDuv() + "\n");
    ...
    m_dTxt.push_back("\t\t\t\t\t\t15點均齊度\tL\t\t\t\t\t15點均齊度\tx\t\t\t\t\t15點均齊度\ty\t\t\t\t\t15點均齊度\tT\t\t\t\t\t15點均齊度\tduv\n");

    for (n = 0; n < 4 ; ++n)
        m_dTxt.push_back(" \n");

    //m_dTxt.push_back("\n\n\n\n");
    m_dTxt.push_back("\t\t\t\t\t\t2010 SEC 15點均齊度-W\tL\t\t\t\t\t2010 SEC 15點均齊度-W\tx\t\t\t\t\t2010 SEC 15點均齊度-W\ty\t\t\t\t\t2010 SEC 15點均齊度-W\tT\t\t\t\t\t2010 SEC 15點均齊度-W\tduv\n");
    
    for (n = 0; n < 4 ; ++n)
        m_dTxt.push_back(" \n");

    m_dTxt.push_back("\t\t\t\t\t\t2010 SEC 15點均齊度-D\tL\t\t\t\t\t2010 SEC 15點均齊度-D\tx\t\t\t\t\t2010 SEC 15點均齊度-D\ty\t\t\t\t\t2010 SEC 15點均齊度-D\tT\t\t\t\t\t2010 SEC 15點均齊度-D\tduv\n");
...
//檔案資料      
	...
	//m_dOmd.At(Red  , Pn9, 0).SetSx( 0.666);
