...
CXlsOQC1& CXlsOQC1::iData(CDataChain& vCar      , std::vector<Cartridge>::size_type ModuleNO){    iCellNO(ModuleNO).iData(m_vCar);              return *this;}
...
CXlsOQC1& CXlsOQC1::iData(CDataChain& vCar)
{
//Step 4.開始設定內容
//-----------------------------------------------------------------------------------------------
//       表格字填完！下面是填入資料！請準備陣列！
