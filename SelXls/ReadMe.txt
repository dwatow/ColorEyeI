========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : SelXls
========================================================================


AppWizard has created this SelXls application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your SelXls application.
...
res\SelXls.ico
    ...
    icon is included by the main resource file SelXls.rc.
...
SelXlsDlg.h, SelXlsDlg.cpp - the dialog
    These files contain your CSelXlsDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in SelXls.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CSelXlsDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named SelXls.pch and a precompiled types file named StdAfx.obj.
