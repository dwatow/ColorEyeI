...
{
	SelectSheet(5);
	SelectCell('M', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkW, Pn4, 0).GetLv());
	SelectCell('N', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkW, Pn4, 1).GetLv());
	SelectCell('O', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkW, Pn4, 2).GetLv());
	SelectCell('P', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkW, Pn4, 3).GetLv());

	SelectCell('R', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkD, Pn4, 0).GetLv());
	SelectCell('S', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkD, Pn4, 1).GetLv());
	SelectCell('T', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkD, Pn4, 2).GetLv());
	SelectCell('U', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlkD, Pn4, 3).GetLv());

	SelectCell('W', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlk , Pn4, 0).GetLv());
	SelectCell('X', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlk , Pn4, 1).GetLv());
	SelectCell('Y', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlk , Pn4, 2).GetLv());
	SelectCell('Z', 9+m_ModuleNO)->SetCell("%3.2f", m_vCar.At(CrsTlk , Pn4, 3).GetLv());
