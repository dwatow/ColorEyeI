...
CXlsFile2* CXlsOQC2::iCellNO(std::vector<Cartridge2>::size_type ModuleNO)
{
    m_ModuleNO = ModuleNO;
...
//////////////////////////////////////////////////////////////////////////
CXlsFile2* CXlsOQC2::iPanelID(CString strPanelID , std::vector<Cartridge2>::size_type ModuleNO){ iCellNO(ModuleNO)->iPanelID(strPanelID);     return this;}
CXlsFile2* CXlsOQC2::iChannel(CString striChannel, std::vector<Cartridge2>::size_type ModuleNO){ iCellNO(ModuleNO)->iChannel(striChannel);    return this;}
CXlsFile2* CXlsOQC2::iNitsLv(CString strNitsLv   , std::vector<Cartridge2>::size_type ModuleNO){ iCellNO(ModuleNO)->iNitsLv(strNitsLv);       return this;}
CXlsFile2* CXlsOQC2::iData(RNA&           , std::vector<Cartridge2>::size_type ModuleNO){ iCellNO(ModuleNO)->iData(m_vCar);            return this;}
...
CXlsFile2* CXlsOQC2::iData(RNA& vCar)
{
    m_vCar = vCar;
